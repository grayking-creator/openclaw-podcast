...
def run_checks(path):
    ...
    internal_impl_patterns = [
        ...
        r"\babsence of (?:a )?(?:general-purpose |frontier |flagship )?(?:model drop|model release|assistant|frontier assistant)\b",
        r"\bno new (?:frontier|flagship|general-purpose) (?:model|assistant|model drop|model release)\b",
        r"\bno (?:frontier|flagship|general-purpose) (?:model|assistant) (?:drop|release)\b",
        r"\bnot-selected items?\b",
