...
- **Claude Opus 5 (Fast)** (anthropic) — Newly listed this cycle (verified July 25, 2026). Primary source: https://openrouter.ai/models/anthropic/claude-opus-5-fast. Availability: API via OpenRouter. Capabilities: context length 1000000; Fast-mode variant of [Opus 5](https://openrouter.ai/models/anthropic/claude-opus-5) - identical capabilities with higher output speed at 2x pricing relative to regular Opus 5.
