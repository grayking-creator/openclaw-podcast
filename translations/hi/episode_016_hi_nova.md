[NOVA]: मैं NOVA हूं, यह OpenClaw Daily है, और आज हमारे पास उन रिलीज़ में से एक है जहां version numbers तो साफ-सुथरे दिखते हैं, लेकिन अंदर की असली कहानी उलझी हुई, असरदार, और सच कहूं तो काफ़ी दिलचस्प है। ... इस हफ्ते, दो bugs ने एक असली power-user setup को इतनी ज़ोर से मारा कि वे आपको लगभग सब कुछ बता देते हैं कि OpenClaw इस समय कहां खड़ा है।
...
[NOVA]: Bug one: एक user ने MiniMax को अपने reasoning model के रूप में configure किया हुआ था। Upstream API api_error throw कर रही थी। OpenClaw ने उसे देखा, तय किया कि यह transient होगा, चुपचाप retry कर दिया, failure कभी surface नहीं किया, fallback को ठीक से trigger नहीं किया, और user को degraded result वापस मिला, बिना इस बात के कि original call fail हुई थी।
...
[NOVA]: बिल्कुल। और bug two दर्द की एक अलग किस्म थी, लेकिन उतनी ही असली। User एक fresh OpenAI Codex token paste करता है, confirmation देखता है, सब कुछ successful लगता है, gateway restart करता है, और token वापस expired credential पर लौट चुका होता है।

[ALLOY]: वह वाला आपको पागल महसूस कराता है। क्योंकि user की नज़र से देखें तो उसने सही काम किया। उसने नया token paste किया। App ने कहा, हां, save हो गया। फिर restart के बाद, नहीं। पुराना ख़राब token फिर वापस। ... अंदर की तरफ, gateway की in-memory auth state restart पर freshly saved disk value को overwrite कर रही थी।

[NOVA]: ये दोनों v2026.3.23 में ठीक किए गए हैं। लेकिन यह समझने के लिए कि ये हुए क्यों, आपको समझना होगा कि v2026.3.22 ने क्या बदला। क्योंकि .22 बड़ा वाला है। .22 वह है जहां OpenClaw ने शायद वह काम किया जो उसे एक साल पहले कर देना चाहिए था।

[NOVA]: Legacy purge. पुराने names, compatibility layers, अजीब transitional paths, browser relay crutches, plugin SDK mush — उसका बड़ा हिस्सा निकाल बाहर किया गया। ... और मुझे लगता है कि इन दो releases को साथ में समझने का सही तरीका यह है: .22 पुरानी मृत खाल हटाता है, और .23 यह पक्का करता है कि नई खाल फटे नहीं।

[ALLOY]: यही पूरा episode है। अगर आप एक real install maintain कर रहे हैं, तो ये decorative updates नहीं हैं। ये structural हैं।

[NOVA]: चलिए सबसे emotionally charged change से शुरू करते हैं, क्योंकि लोग names से अजीब तरह से चिपक जाते हैं, तब भी जब उन names को बहुत पहले retire कर देना चाहिए था। CLAWDBOT_* और MOLTBOT_* environment names अब गए। Deprecated नहीं। Warning के साथ tolerate नहीं। गए।

[ALLOY]: और मैं इसे थोड़ा धीमा करके कहना चाहता हूं, क्योंकि अगर आप OpenClaw को सिर्फ़ एक laptop पर चलाते हैं और कहीं नहीं, तो आप यह सुनकर सोच सकते हैं, ठीक है, कुछ variables rename करने हैं, fine। असली failure mode यह नहीं है। असली failure mode यह है कि आपके पास Docker Compose में कोई पुरानी .env file है, या किसी VPS पर कोई जंग लगा systemd unit, या shell profile में कुछ ऐसा है जिसे आपने आठ महीने से देखा नहीं। आप upgrade करते हैं, OpenClaw शुरू होता है, और वे values चुपचाप ignore हो जाती हैं।

[NOVA]: कोई error नहीं। कोई migration banner नहीं।

[ALLOY]: कोई यह नहीं कहता, "hey, मैंने CLAWDBOT_TOKEN देखा और यह obsolete है।" बस config गायब। अचानक auth line up नहीं करता, state path वहां नहीं है जहां आपने सोचा था, शायद plugin load नहीं होता, शायद token गायब लगता है। ... यह उसी तरह की breakage है जो सुबह दो बजे upgrade के बाद उस machine पर लगती है जिसे आपने काफी समय से छुआ भी नहीं।

[NOVA]: अपनी env files grep कीजिए। हर environment में जिसमें आप OpenClaw चलाते हैं। हर host। हर Compose file। हर startup unit। हर shell bootstrap। अगर आपके पास CLAWDBOT_* या MOLTBOT_* है, तो उसे ठीक होने तक broken मानिए।

[ALLOY]: पुरानी ~/.moltbot state directory के साथ भी यही कहानी है। वह path अब future का हिस्सा नहीं है। अगर आपकी state अभी भी वहीं रहती है, तो upgrade के बाद OpenClaw आपके लिए यह जादुई तरीके से infer नहीं करेगा। उसे ~/.openclaw में move कीजिए या OPENCLAW_STATE_DIR को explicitly set कर दीजिए और काम ख़त्म कीजिए।
...
[NOVA]: ठीक बात। ... .22 में दूसरा बड़ा breaking change यह है कि ClawHub अब first-class है, और इसका practical मतलब marketing phrasing से कहीं बड़ा है। openclaw plugins install name अब पहले ClawHub check करता है, और केवल तब npm पर fallback करता है जब ClawHub में package मौजूद न हो।
...
[NOVA]: अब native commands भी हैं: openclaw skills search, openclaw skills install, openclaw skills update। ... और मेरे लिए यह OpenClaw का आखिरकार product को उसके intended ecosystem के साथ align करना है। ClawHub हमेशा skills का घर होना चाहिए था। यह release उसे aspirational के बजाय real बना देती है।
...
[NOVA]: तीसरा: Plugin SDK overhaul। यह किनारों पर हल्का सा कुतरना नहीं है। openclaw/extension-api चला गया। कोई compatibility shim नहीं है। नया surface है openclaw/plugin-sdk/*, narrower subpaths और कहीं ज्यादा साफ़ boundaries के साथ।
...
[ALLOY]: और message discovery भी बदली है। describeMessageTool() अब required है। पुराना listActions, getCapabilities, getToolSchema flow हटा दिया गया है। ... यह rename नहीं है। यह contract change है।

[NOVA]: नया SDK सच में cleaner है। genuinely। Imports narrower हैं। Intent ज्यादा स्पष्ट है। Runtime model ज्यादा coherent है। लेकिन आपको migrate करना होगा। और अगर आप plugin developer हैं, तो docs.openclaw.ai/plugins/sdk-migration पढ़िए। Memory के भरोसे improvise मत कीजिए।

[ALLOY]: मैं उस पर ज़ोर देना चाहता हूं। यह वह हफ्ता नहीं है जब आप vibes के भरोसे अपनी migration freehand करें।

[NOVA]: चौथा bucket: security hardening। इनमें से कुछ तब तक invisible रहते हैं जब तक वे आपको बचा न लें, इसलिए इन्हें उतना airtime नहीं मिलेगा, लेकिन ये मायने रखते हैं। Exec sandbox अब MAVEN_OPTS, SBT_OPTS, GRADLE_OPTS, ANT_OPTS, साथ ही GLIBC_TUNABLES और DOTNET_ADDITIONAL_DEPS को block करता है। ... यह मूल रूप से उन runtime injection surfaces के खिलाफ एक sweep है जिन्हें लोग भूल जाते हैं कि वे वहां हैं।
...
[NOVA]: एक subtle लेकिन smart allowlist change भी है: time अब allowlist evaluation में transparent है। तो time ./approved-script अब time wrapper नहीं, बल्कि अंदर की script से bind करता है।

[ALLOY]: वह बहुत practical है। लोग debugging के दौरान commands को time में हर समय wrap करते हैं। पहले wrappers अजीब policy edge cases बना सकते थे। अब यह उसी चीज़ को evaluate करता है जिसे आप वास्तव में चलाना चाहते थे।

[NOVA]: और voice webhook hardening भी कड़ी हुई है: body read करने से पहले missing provider signatures reject करो, 64KB और 5s pre-auth limit के साथ। यह बस sound perimeter hygiene है। Unauthenticated junk को parse करने में resources मत खर्च करो।
...
[NOVA]: हमें browser tooling पर ठीक से समय देना होगा, क्योंकि बहुत से users के लिए यह इन दो releases में सबसे बड़ा operational change है। Legacy Chrome extension relay चला गया। driver: "extension", bundled extension assets, browser.relayBindHost — सब हटाए गए।

[ALLOY]: और अगर आप उस दौर में नहीं थे, तो extension असल में था क्या, यह समझिए। OpenClaw पहले एक Chrome extension ship करता था जो CDP, यानी Chrome DevTools Protocol, के लिए relay की तरह काम करता था। आप extension manually install करते थे, browser permissions grant करते थे, और वह OpenClaw और browser के बीच bridge का काम करता था।
...
[NOVA]: Replacement model बस बेहतर है। OpenClaw अब standard CDP mechanisms का उपयोग करके एक running Chrome instance या user profile से direct attach करता है। Extension की ज़रूरत नहीं। बीच में कोई custom relay नहीं। ... Architectural नज़र से यह साफ़ है। कम bespoke layers। Tooling में छिपे कम secrets।

[ALLOY]: लेकिन — और यही महत्वपूर्ण practical warning है — अगर आप upgrade करने से पहले, या कम से कम उसके तुरंत बाद, openclaw doctor --fix नहीं चलाते, तो आपका browser automation पूरी तरह टूट सकता है। और यह हमेशा obvious तरीके से नहीं टूटेगा। ज़रूरी नहीं कि आपको कोई friendly message मिले जो कहे, "extension relay हट गया।" ज़्यादा संभव यह है कि वह connect ही न करे, या consent अजीब loop में फंस जाए, या attach path आधा जिंदा लगे और फिर मर जाए।

[NOVA]: openclaw doctor --fix आपकी current config पढ़ता है और host-local browser setups को सही modern mode में migrate करता है: existing-session या user। यह cosmetic recommendation नहीं है। यह migration का हिस्सा है।

[ALLOY]: और अब तीन modes को clarify करना भी ज़रूरी है। existing-session का मतलब है एक running Chrome से attach करना। user का मतलब है user profile के साथ launch करना। Raw CDP Docker, headless, sandbox, remote setups के लिए — वह लगभग unchanged रहता है।
...
[NOVA]: और अगर आप host-local browser automation चलाते हैं, तो doctor --fix को general maintenance chore नहीं, browser migration के हिस्से के रूप में treat कीजिए। वह targeted work कर रहा है।

[ALLOY]: हां। Optional housekeeping नहीं। Migration step।

[NOVA]: और browser shift में एक बड़ा lesson भी है। Browser automation उन क्षेत्रों में से एक है जहां लोग absurd complexity को tolerate करते हैं क्योंकि payoff इतना बड़ा होता है। वे extension install करेंगे, version pin करेंगे, profile bless करेंगे, weird launch flags उठाएंगे, कुछ भी करेंगे, बस browser उनकी बात माने। ... लेकिन हर hidden workaround user interface के साथ technical debt बन जाता है।
...
[NOVA]: अब image generation। यह browser tooling जितना dramatic नहीं है, लेकिन यह आपको बहुत कुछ बताता है कि OpenClaw कहां जा रहा है। Bundled nano-banana-pro skill हटा दी गई है। Gone। कोई shim नहीं।

[ALLOY]: जिसका मतलब है कि अगर आपके workflows, prompts, या internal docs nano-banana-pro को call करते हैं, तो उन्हें ढूंढिए और replace कीजिए। यह hard break है। यह assume मत कीजिए कि कोई alias आपका इंतज़ार कर रहा होगा।

[NOVA]: Platform अब image_generate core tool पर standardize कर रहा है। और philosophical स्तर पर मुझे लगता है कि यह बिल्कुल सही है। एक tool, configurable backend, consistent invocation surface। यह उससे बेहतर है कि सिर्फ़ इसलिए bundled skill wrapper को हमेशा ढोते रहें क्योंकि लोग उसके नाम के आदी हो गए।

[ALLOY]: बशर्ते आप config key set करें। यही वह हिस्सा है जिसे लोग skip कर देते हैं। आपको agents.defaults.imageGenerationModel.primary: "google/gemini-3-pro-image-preview" चाहिए। अगर आपने यह set नहीं किया, तो behavior undefined है। और config land में undefined का मतलब कभी exciting नहीं होता। उसका मतलब confusing होता है।
...
[NOVA]: Fair criticism। ... इस shift के साथ marketplace improvements भी आई हैं। Marketplace installs अब first-class हैं, जिनमें plugin@marketplace syntax और Claude marketplace registry support शामिल है।
...
[NOVA]: और owner-gated /plugins और /plugin chat commands उसी theme को आगे बढ़ाते हैं: platform को extensions खोजने, install करने और manage करने के लिए एक coherent story दो।
...
[NOVA]: मेरे लिए image generation की कहानी यह है: OpenClaw bundled personality से configured capability की ओर बढ़ रहा है। ... यही maturity है।
...
[NOVA]: यह teams के portability के बारे में सोचने का तरीका भी बदलती है। अगर आपका workflow image_generate कहता है और backend अलग से configured है, तो आप workflow logic rewrite किए बिना provider migrate कर सकते हैं।
...
[NOVA]: Fix बहुत precise है। यह नहीं कि "MiniMax पर retry करना बंद कर दो।" यह है, "सिर्फ़ तब retry करो जब error सच में transient दिखे।" ... मुझे इस तरह की fix पर भरोसा होता है, क्योंकि यह original design goal — resilience — को बचाए रखती है, जबकि sloppy classification हटा देती है जिसने resilience को concealment जैसा बना दिया था।
...
[ALLOY]: तो आप token paste करते थे, green confirmation देखते थे, restart करते थे, और expired। हर बार। ... यही वजह है कि यह bug इतनी personal महसूस हुई। उसने credentials save करने की बुनियादी क्रिया पर trust पर हमला किया।
...
[NOVA]: ठोस उदाहरण: आप 8 AM job schedule करते हैं। DST आ जाता है। .23 से पहले, वह "8 AM" 7 AM या 9 AM बन सकता था, यह इस पर निर्भर करता था कि scheduler boundary को कैसे interpret कर रहा है। ... यह सिर्फ़ cosmetic mismatch नहीं है। Daily routine के लिए यह टूटा हुआ वादा है।

[ALLOY]: Fix यह है कि --at --tz अब DST boundaries के पार local wall-clock time का सम्मान करता है। और OpenClaw --every के लिए --tz reject भी करता है, जो अच्छा है क्योंकि recurring interval semantics और timezone wall-clock semantics एक चीज़ नहीं हैं।
...
[NOVA]: चौथा: Mistral 422 fix। पुरानी persisted Mistral configs context-sized output limits carry कर रही थीं जिन्हें Mistral सीधे reject करता है। परिणाम: 422 errors जो mysterious लगती हैं अगर आपको config lineage नहीं पता।

[ALLOY]: और फिर वही, openclaw doctor --fix यहां असली काम कर रहा है। अब यह stale Mistral configs detect और repair करता है।

[NOVA]: doctor --fix चलाने का एक और कारण। लोग कभी-कभी इस command को generic doctoring की तरह सुनते हैं, जैसे शायद यह कुछ obvious चीजें tidy कर देगी। नहीं। इस release train में यह migration knowledge को codify कर रही है।

[ALLOY]: पांचवां: macOS पर ClawHub। यहां दो issues थीं। Saved credentials macOS Application Support path का सही सम्मान नहीं कर रही थीं, और browse-all behavior unauthenticated 429 rate limits से टकरा रहा था।

[NOVA]: जिसका मतलब है कि UI आपको vague तरीकों से यह महसूस करा सकती थी कि ClawHub खाली है या broken है।

[ALLOY]: macOS पर skill browsing चुपचाप unauthenticated पर fallback कर रही थी। आप empty lists देखते और मान लेते कि skills हैं ही नहीं, या आपका install टूटा हुआ है, जबकि असल में auth path handling गलत थी। ... Fixes थीं सही auth path का सम्मान करना और browse-all को search endpoint पर shift करना, जो pointless unauthenticated throttling से बचने का कहीं ज्यादा sane तरीका है।
...
[NOVA]: सातवां: web_search stale provider handling। Tool startup पर baked हुई provider state का इस्तेमाल कर रहा था, active runtime config का नहीं।
...
[NOVA]: आठवां: Telegram threading। currentThreadTs अब Telegram DM topics के लिए threading tool-context fallback में populate होता है, ताकि thread-aware tools को सही topic context मिले।
...
[NOVA]: चलिए छोटे बदलावों पर आते हैं, क्योंकि वे सिर्फ़ surface area में छोटे हैं, महत्व में ज़रूरी नहीं। पहला: Qwen और DashScope। OpenClaw अब China और global Qwen API keys के लिए standard DashScope endpoints को support करता है, और provider को Qwen (Alibaba Cloud Model Studio) के नाम से relabel किया गया है।
...
[NOVA]: अगला: CSP hardening। Inline script blocks के लिए SHA-256 hashes। Inline scripts default रूप से blocked।

[ALLOY]: अगर आप OpenClaw को strict reverse proxy के पीछे चलाते हैं, तो upgrade करने के लिए यही version है।

[NOVA]: यह supply chain security के लिए मायने रखता है। Injected script execute नहीं होगी क्योंकि hash match नहीं करेगा। ... यही वे controls हैं जो demo को सुंदर नहीं बनाते, लेकिन आपका blast radius छोटा कर देते हैं।
...
[NOVA]: Knot theme पर भी ध्यान दिया गया: WCAG 2.1 AA contrast compliance, black-and-red palette tuning, config icons, discrete roundness stops।
...
[ALLOY]: openclaw doctor --fix। पहले, हर चीज़ से पहले। और सच कहूं तो अगर आप sequence को साफ़ तरीके से कर रहे हैं, तो हर upgrade stage के तुरंत बाद भी।

[NOVA]: इन releases के लिए यही anchor command है। Nice-to-have नहीं। Anchor।

[ALLOY]: Step two: CLAWDBOT_* और MOLTBOT_* को सभी .env files, Docker files, systemd units, shell profiles, हर उस startup surface में grep कीजिए जो आपके पास है।

[NOVA]: अगर पुराने names मौजूद हैं, तो मान लीजिए वे अब dead config हैं।

[ALLOY]: Step three: ~/.moltbot को check कीजिए। अगर वह मौजूद है, तो state को ~/.openclaw में move कीजिए या OPENCLAW_STATE_DIR को explicitly set कीजिए।

[NOVA]: Step four: agents.defaults.imageGenerationModel.primary: "google/gemini-3-pro-image-preview" set कीजिए। Image generation को undefined limbo में मत छोड़िए।
...
[ALLOY]: Step seven: अगर आपके पास custom plugins हैं, तो openclaw/extension-api से openclaw/plugin-sdk/* पर migrate कीजिए। Migration docs पढ़िए। Compile errors को map मत समझिए।
...
[ALLOY]: Step nine: --at --tz इस्तेमाल करने वाले cron jobs verify कीजिए, खासकर अगर DST ने आपको पहले कभी जलाया हो।
...
[ALLOY]: पहले Doctor --fix। बाकी सब इस पर depend करता है कि आप क्या चला रहे हैं। लेकिन doctor --fix unconditional है।
...
[NOVA]: जो OpenClaw जैसे tool के लिए novelty से ज्यादा मायने रखता है। ... Reliability एक feature है। Naming consistency एक feature है। Honest migration pressure एक feature है। कम improvised bridges वाला browser stack एक feature है।

[ALLOY]: और अगर आप अभी upgrade के बीच में हैं, तो एक सांस लीजिए, checklist बनाइए, openclaw doctor --fix चलाइए, और verification steps सिर्फ़ इसलिए मत छोड़िए कि service वापस ऊपर आ गई।

[NOVA]: Show notes, हमने जिन सभी links का ज़िक्र किया, और episode archive आपको tobyonfitnesstech.com पर मिलेंगे। वही है tobyonfitnesstech.com।
